    ...
    layer.open({
     ...
     $(".add_menber input[type$='text']").each(function(n){
		  ...
		  if(num>0){  return false;}	 	
			  ...
			  insertMemberInfo().done(function(result){
			   console.log(result)
              if(result.code == "0"){
                  layer.alert('添加成功！',{
               title: '提示框',				
...
function member_edit(id){
	$.ajax({
			type:"POST",
			url:"/ssm/member/updateMemberInfo",
			dataType:"json",
			data:{'id':id},
			success:function(result){
				...
				if(result.code == "0"){
					...
					$("input[name='update_name']").val(merchantList.userName);
					$("input[name='update_realname']").val(merchantList.realName);
					$("input[name='update_idNumber']").val(merchantList.idNumber);
					$("input[name='update_phone']").val(merchantList.phoneNumber);
					$("input[name='update_emall']").val(merchantList.emall);
					$("select[name='update_statusoption']").val(merchantList.status);
					$("select[name='update_selectoption']").val(merchantList.clientLevel);
					$("input[name='update_adderss']").val(merchantList.adderss);
				}else{
     ...
     $(".update_menber input[type$='text']").each(function(n){
		  ...
		  if(num>0){  return false;}	 	
				...
				var realname = $("input[name='update_realname']").val();
				var idNumber = $("input[name='update_idNumber']").val();
				var phone = $("input[name='update_phone']").val();
				var emall = $("input[name='update_emall']").val();
				var status = $("select[name='update_statusoption']").val();
...
function member_del(obj,id){
	...
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			url:'/ssm/member/deleteMemberInfo',
			type:'POST',
			data:{'id':id},
			dataType:'json',
			success:function(result){
...
function insertMemberInfo(){
  ...
  var memberLevel = $("select[name='selectoption']").val();
